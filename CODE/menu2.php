        ...
        <br>
            <div style="margin: 0 2% 0% ">
                ...
                <table id="example" style="width:100%" class="table">
                    ...
                    <?php
                    include 'sql/sql.php';
                    $consulta = $conexao->prepare("select * from chamados where id_user= 32");
                    ...
                    ?>
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td> <a class="btn btn-primary btn-sm" style="color:white" href="user/chamadosnovo.php?id=<?php echo $id ?>" role="button"><i class="fa-solid fa-pen-to-square"></i> visualizar </a> </td>
                        </tr>
