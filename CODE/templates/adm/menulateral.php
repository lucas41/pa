...
<div class="left-side-menu" id="left-side-bar">
    <div class="slimscroll-menu" id="left-side-menu-container"><a href="#" class="logo text-center"><span class="logo-lg"><img src="/CODE/public/images/logo.png" height="100" id="side-main-logo"> </span></a>
        <ul class="mt-3 metismenu side-nav" id="left-bar-menu">
            ...
            <li class="side-nav-item"><a href="/CODE/administrador/view/chamado-todos.php" class="side-nav-link"><i class="dripicons-view-list"></i>
                    <span>Todos chamados</span></a></li>
            <li class="side-nav-item"><a href="/CODE/administrador/view/chamado-ativos.php" class="side-nav-link"><i class="dripicons-view-list"></i>
                    <span>Chamados ativos</span></a></li>
            <li class="side-nav-item"><a href="/CODE/administrador/view/chamado-finalizados.php" class="side-nav-link"><i class="dripicons-view-list"></i>
