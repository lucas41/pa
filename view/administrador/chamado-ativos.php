                    ...
                    <table id="example" style="width:100%" class="table">
                        ...
                        ?>
                            ...
                            <tr style="text-align: center;">
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm" href="/view/administrador/chamado-detalhado.php?id=<?php echo $id ?>" role="button"> visualizar </a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <!-- INICIO FORM STATUS -->
                                                    <form action="/model/administrador/atualiza-status.php" method="post" enctype="multipart/form-data">
